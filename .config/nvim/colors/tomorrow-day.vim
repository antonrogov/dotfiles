...
let g:colors_name = "tomorrow-day"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("NormalNC", s:foreground, "fbfbfb", "")
	call <SID>X("LineNr", "bbbbbb", "", "")
	call <SID>X("CursorLineNr", s:foreground, "", "")
	" highlight LineNr term=bold cterm=NONE ctermfg=DarkGrey ctermbg=NONE gui=NONE guifg=DarkGrey guibg=NONE
	" highlight CursorLineNr term=bold cterm=NONE ctermfg=red ctermbg=NONE gui=NONE guifg=red guibg=NONE
	...
	if version >= 700
		call <SID>X("CursorLine", "", "fcfcfc", "none")
    call <SID>X("CursorColumn", "", "fcfcfc", "none")
    call <SID>X("PMenu", s:foreground, s:selection, "none")
		call <SID>X("PMenuSel", s:foreground, s:selection, "reverse")
		call <SID>X("SignColumn", "", "none", "none")
	end
	if version >= 703
		call <SID>X("ColorColumn", s:foreground, "fcfcfc", "none")
	end
