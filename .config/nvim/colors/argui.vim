...
hi link @type.tsx cType
hi link @type.builtin.tsx cType
hi link @tag.tsx Function
hi link @tag.attribute.tsx Variable

let g:colors_name = "argui"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("NormalNC", s:foreground, s:bg_alt, "")
	call <SID>X("LineNr", s:base5, "", "none")
	...
	call <SID>X("StatusLineNC", s:base5, s:base1, "none")
	" call <SID>X("VertSplit", s:window, s:window, "none")
	call <SID>X("VertSplit", s:line, s:line, "none")
	call <SID>X("WinSeparator", s:base4, s:background, "none")
	...
	if version >= 700
		call <SID>X("CursorLine", "", s:base1, "none")
	  call <SID>X("CursorLineNr", s:foreground, "", "none")
		call <SID>X("CursorColumn", "", s:base1, "none")
		call <SID>X("PMenu", "", s:background, "")
		call <SID>X("NormalFloat", s:base5, s:background, "")
		call <SID>X("PMenuSel", s:foreground, s:selection, "reverse")
		call <SID>X("SignColumn", "", "none", "none")
	end
	if version >= 703
		call <SID>X("ColorColumn", s:foreground, s:base1, "none")
	end
	...
	call <SID>X("Variable", s:red, "", "none")
