...
;; URL: <https://github.com/nashamri/anton-theme>
;;
;; Version: 0.1
...
(defgroup anton-theme nil
  "anton-theme options."
  :group 'faces)

(defcustom anton-theme-comment-bg t
  "Use a background for comment lines."
  :type 'boolean
  :group 'anton-theme)

(defcustom anton-theme-org-agenda-height t
  "Use varying text heights for org agenda."
  :type 'boolean
  :group 'anton-theme)

(defcustom anton-theme-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'anton-theme)

(defcustom anton-theme-org-highlight nil
  "Highlight org headings."
  :type 'boolean
  :group 'anton-theme)

(defcustom anton-theme-custom-colors nil
...
(defun custom-colors-override ()
  (mapcar (lambda (x) (list (car x) (cdr x)))
          anton-theme-custom-colors))

(defun create-anton-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (base          (if (eq variant 'dark) (if (true-color-p) "#b2b2b2" "#E1E0E1") (if (true-color-p) "#655370" "#5f5f87")))
        (base-dim      (if (eq variant 'dark) (if (true-color-p) "#686868" "#585858") (if (true-color-p) "#a094a2" "#afafd7")))
        (bg1           (if (eq variant 'dark) (if (true-color-p) "#292b2e" "#1c1c1c") (if (true-color-p) "#fbf8ef" "#ffffff")))
        (bg2           (if (eq variant 'dark) (if (true-color-p) "#212026" "#262626") (if (true-color-p) "#efeae9" "#e4e4e4")))
        ...
        (const         (if (eq variant 'dark) (if (true-color-p) "#a45bad" "#87AF5F") (if (true-color-p) "#4e3163" "#8700af")))
        ...
        (func          (if (eq variant 'dark) (if (true-color-p) "#bc6ec5" "#FFD75F") (if (true-color-p) "#6c3163" "#8700af")))
        ...
        (keyword       (if (eq variant 'dark) (if (true-color-p) "#4f97d7" "#D7875F") (if (true-color-p) "#3a81c3" "#268bd2")))
        (lnum          (if (eq variant 'dark) (if (true-color-p) "#44505c" "#666666") (if (true-color-p) "#a8a8bf" "#af87af")))
        ...
        (str           (if (eq variant 'dark) (if (true-color-p) "#2d9574" "#87AF5F") (if (true-color-p) "#2d9574" "#2aa198")))
        ...
        (type          (if (eq variant 'dark) (if (true-color-p) "#ce537a" "#D75F5E") (if (true-color-p) "#ba2f59" "#af005f")))
        (var           (if (eq variant 'dark) (if (true-color-p) "#7590db" "#FFD7AF") (if (true-color-p) "#715ab1" "#af5fd7")))
...
;;;;; basics
     ...
     `(font-lock-comment-face ((,class (:foreground ,comment :background ,(when anton-theme-comment-bg comment-bg)))))
...
;;;;; latex
     ...
     `(font-latex-sectioning-0-face ((,class (:inherit bold :foreground ,head3 :height ,(if anton-theme-org-height 1.3 1.0) :background ,(when anton-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-1-face ((,class (:inherit bold :foreground ,head4 :height ,(if anton-theme-org-height 1.3 1.0) :background ,(when anton-theme-org-highlight head4-bg)))))
     `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,head1 :height ,(if anton-theme-org-height 1.3 1.0) :background ,(when anton-theme-org-highlight head1-bg)))))
     `(font-latex-sectioning-3-face ((,class (:inherit bold :foreground ,head2 :height ,(if anton-theme-org-height 1.2 1.0) :background ,(when anton-theme-org-highlight head2-bg)))))
     `(font-latex-sectioning-4-face ((,class (:bold nil :foreground ,head3 :height ,(if anton-theme-org-height 1.1 1.0) :background ,(when anton-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-5-face ((,class (:bold nil :foreground ,head4 :background ,(when anton-theme-org-highlight head4-bg)))))
...
;;;;; markdown
     `(markdown-header-face-1 ((,class (:inherit bold :foreground ,head1 :height ,(if anton-theme-org-height 1.3 1.0) :background ,(when anton-theme-org-highlight head1-bg)))))
     `(markdown-header-face-2 ((,class (:inherit bold :foreground ,head2 :height ,(if anton-theme-org-height 1.2 1.0) :background ,(when anton-theme-org-highlight head2-bg)))))
     `(markdown-header-face-3 ((,class (:bold nil :foreground ,head3 :height ,(if anton-theme-org-height 1.1 1.0) :background ,(when anton-theme-org-highlight head3-bg)))))
     `(markdown-header-face-4 ((,class (:bold nil :foreground ,head4 :background ,(when anton-theme-org-highlight head4-bg)))))
...
;;;;; org
     ...
     `(org-agenda-date ((,class (:foreground ,var :height ,(if anton-theme-org-agenda-height 1.1 1.0)))))
     `(org-agenda-date-today ((,class (:foreground ,keyword :inherit bold :height ,(if anton-theme-org-agenda-height 1.3 1.0)))))
     `(org-agenda-date-weekend ((,class (:inherit bold :foreground ,var))))
     `(org-agenda-done ((,class (:foreground ,suc :height ,(if anton-theme-org-agenda-height 1.2 1.0)))))
     ...
     `(org-document-title ((,class (:foreground ,func :inherit bold :height ,(if anton-theme-org-height 1.4 1.0) :underline t))))
     ...
     `(org-level-1 ((,class (:inherit bold :foreground ,head1 :height ,(if anton-theme-org-height 1.3 1.0) :background ,(when anton-theme-org-highlight head1-bg)))))
     `(org-level-2 ((,class (:inherit bold :foreground ,head2 :height ,(if anton-theme-org-height 1.2 1.0) :background ,(when anton-theme-org-highlight head2-bg)))))
     `(org-level-3 ((,class (:bold nil :foreground ,head3 :height ,(if anton-theme-org-height 1.1 1.0) :background ,(when anton-theme-org-highlight head3-bg)))))
     `(org-level-4 ((,class (:bold nil :foreground ,head4 :background ,(when anton-theme-org-highlight head4-bg)))))
     ...
     `(org-scheduled-today ((,class (:foreground ,func :height ,(if anton-theme-org-agenda-height 1.2 1.0)))))
...
;;;;; smartparens
     ...
     `(sp-show-pair-match-face ((,class (:foreground ,mat :background ,highlight))))
...
(deftheme anton "Anton theme")

(create-anton-theme 'dark 'anton)
